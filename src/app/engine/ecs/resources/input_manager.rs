...
pub fn update_mouse_delta(input_manager: &mut ResMut<InputManager>, delta: [f64; 2]) {
    input_manager.mouse_delta = delta;
}

pub fn update_or_add_keybind(input_manager: &mut ResMut<InputManager>, keybind: Keybind) {
...
pub fn process_keyboard_input(input_manager: &mut ResMut<InputManager>, event: &KeyEvent) {
...
pub fn is_key_pressed(input_manager: &mut ResMut<InputManager>, key: PhysicalKey) -> bool {
...
pub fn is_key_released(input_manager: &mut ResMut<InputManager>, key: PhysicalKey) -> bool {
...
pub fn is_key_held(input_manager: &ResMut<InputManager>, key: PhysicalKey) -> bool {
    input_manager.keys_held.contains(&key)
}

pub fn is_keybind_triggered(input_manager: &ResMut<InputManager>, keybind: &Keybind) -> bool {
...
pub fn is_keybind_name_triggered(
